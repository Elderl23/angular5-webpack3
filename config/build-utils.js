// all credits to Shlomi Assaf (@shlassaf) and @gdi2290
// https://github.com/gdi2290/angular-starter/blob/master/config/build-utils.js
...
const DEFAULT_METADATA = {
  ...
  mediaUrl: helpers.isWebpackDevServer() ? '' : '/janus',
